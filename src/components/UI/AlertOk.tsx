...
function Alert({ title, description = "", type = "", color = "red" }: any) {
    ...
    return (
        <div id="alert-show" className={`absolute bottom-0  p-4 mb-4 text-sm text-${color}-800 rounded-lg bg-${color}-50 dark:bg-gray-800 dark:text-${color}-400 ${style.alert}`} role="alert">
