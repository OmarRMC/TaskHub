...
function SelectForm({ name, listData, select, handleChange, required=false }: { name: string, listData?: any, select?: any, handleChange?: (tag: tagType) => void , required?:boolean}) {
